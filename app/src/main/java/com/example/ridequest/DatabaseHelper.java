...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE Reservation (booking_id INTEGER PRIMARY KEY AUTOINCREMENT, customer_num INTEGER, vehicle_id INTEGER, reservation_date TEXT, pickup_date TEXT, return_date TEXT, status TEXT, FOREIGN KEY(customer_num) REFERENCES Customer(customer_id), FOREIGN KEY(vehicle_id) REFERENCES Vehicle(vehicle_id))");
        ...
        // Seed Admin & Location
        db.execSQL("INSERT INTO Location (location_name) VALUES ('Cebu HQ')");
